...
**Table S9a.** Summary table for abundance disturbance model at 50 m buffer distance. We present 50 m distance because the top model is a local effect (flower diversity and average % bloom) measured at the pond, so buffer distance is not relevant for abundance.
